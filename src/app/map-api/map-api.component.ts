import {  AfterViewInit, Component, ElementRef, OnDestroy, OnInit, Renderer2, ViewChild, Input, ViewChildren, QueryList } from '@angular/core';
...
export class MapApiComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    //   var lon = this.ListCoor.length;
    //   console.log("LONGITUD DEL ARRAY SACADO = "+lon);
    // for (var i = 0; i < this.ListCoor.length; i++) {
    //   console.log("Entra for")
    //   var objCoorde = this.ListCoor[i];
    //   console.log("ESPACIO "+i);
